...
inline void * cheri_seal_cap( void * unsealed_cap,
                              size_t otype )
{
    void * sealer = __builtin_cheri_address_set( root_data_cap, otype );
...
inline void * cheri_unseal_cap( void * sealed_cap )
{
    ...
    void * unsealer = __builtin_cheri_address_set( root_code_cap, otype );
...
inline void * cheri_build_data_cap( ptraddr_t address,
                                    ...
                                    size_t perms )
{
    void * returned_cap = root_data_cap;
...
inline void * cheri_build_code_cap( ptraddr_t address,
                                    ...
                                    size_t perms )
{
    void * returned_cap = root_code_cap;
